using Ordina.TFSMonitor.Win8.Common;
...
using Ordina.TFSMonitor.Win8.Views;

// The Grid App template is documented at http://go.microsoft.com/fwlink/?LinkId=234226

namespace Ordina.TFSMonitor.Win8
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        {
            SettingsCommand command = new SettingsCommand("Accounts", "My account", (x) =>
            {
